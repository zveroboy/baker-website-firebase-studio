...
export const products: Product[] = [
  {
    ...
    longDescription: 'Мой "Наполеон" — это хрустящие, тающие во рту коржи, прослоенные воздушным заварным кремом по старинному рецепту. Каждый кусочек - это путешествие в детство. Идеально подходит для семейного чаепития или торжественного события.',
    price: 1500, // per kg
    unit: 'kg',
    minWeight: 1,
    maxWeight: 5,
  ...
  },
  {
    ...
    longDescription: 'Нежный, ароматный и очень домашний торт "Медовик". Тонкие медовые коржи, пропитанные легким сметанным кремом, создают неповторимый вкус, который любят и взрослые, и дети. Я использую только натуральный цветочный мед.',
    price: 1400, // per kg
    unit: 'kg',
    minWeight: 1,
    maxWeight: 4,
  ...
  },
  {
    ...
    longDescription: 'Плотный, сливочный и насыщенный — это все о моем чизкейке "Нью-Йорк". Я готовлю его из лучшего сливочного сыра на тонкой основе из песочного печенья. Подается с ягодным соусом.',
    price: 1800, // per kg
    unit: 'kg',
    minWeight: 1.2,
    maxWeight: 3.6,
...
export const faqs: FAQ[] = [
  {
    ...
    answer: 'Я рекомендую делать заказ на торты за 3-5 дней, на пирожные и десерты — за 1-2 дня. Для срочных заказов, пожалуйста, свяжитесь со мной по телефону.',
  },
  {
    id: '2',
    question: 'Какие у вас есть варианты доставки?',
    answer: 'Вы можете забрать заказ самостоятельно (самовывоз) из моей кондитерской или заказать доставку курьером по городу. Стоимость доставки рассчитывается индивидуально в зависимости от района.',
  },
  {
    id: '3',
    question: 'Используете ли вы натуральные ингредиенты?',
    answer: 'Да, я горжусь тем, что использую только высококачественные и натуральные ингредиенты: настоящее сливочное масло, свежие яйца, натуральные сливки и бельгийский шоколад.',
  },
  {
    id: '4',
    question: 'Можно ли сделать торт с индивидуальным дизайном?',
    answer: 'Конечно! Я с радостью обсужу ваши идеи и создам торт вашей мечты. Свяжитесь со мной, чтобы обсудить детали дизайна, начинки и стоимость.',
  },
];
